                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="name" name="name" type="text" required value="{{ old('name') }}"
                            ...
                            @error('name') ring-red-500 text-red-900 focus:ring-red-600 @else ring-gray-300 text-gray-900 focus:ring-indigo-600 @enderror">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="username" name="username" type="text" required value="{{ old('username') }}"
                            class="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 
                            @error('username') ring-red-500 text-red-900 focus:ring-red-600 @else ring-gray-300 text-gray-900 focus:ring-indigo-600 @enderror">
